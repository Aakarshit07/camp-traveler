...
const CampSite = ({ backgroundImage, title, subtitle, peopleJoined }: CampProps) => {
  return (
    <div className={`h-full w-full min-w-[1100px] ${backgroundImage} bg-center bg-cover bo-no-repeat lg:rounded-r-5xl 2xl:rounded-5xl`}>
...
const Camp = () => {
  return (
    <section className="2xl: max-container relative flex flex-col py-10 lg:mb:py-20 xl:md-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        <CampSite 
          backgroundImage="bg-bg-img-1" 
          title="Wild Camp Area" 
          subtitle="The wild side of the camp area"
          peopleJoined="50+ Joined"
        />
        <CampSite 
          backgroundImage="bg-bg-img-2" 
          title="Mountain View Camp" 
          subtitle="The mountain side of the camp area"
          peopleJoined="50+ Joined"
        />
      </div>
