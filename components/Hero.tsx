...
const Hero = () => {
  return (
    ...
    py-10 pb-32 md:gap-28 lg:py-20 xl:flex-rows">
      <div className="hero-map" />

      {/* LEFT */}

      <div className="relative -20 flex flex-1 flex-col xl:w-1/2">
        <Image 
          src="/camp.svg" 
          alt="camp" 
          width={50}
        ...
        />
        <h1 className="bold-52 lg:bold-88">Kangchenjunga Camp Area</h1>
      ...
      <div className="my-11 flex flex-wrap gap-5">
        ...
        <p className="bold-16 lgLbold-20 text-blue-70">
          198k
      ...
      <div className="relative flex flex-1 items-start">
        <div className="relative z-20 flex flex-col w-[268px] gap-8 rounded-3xl bg-green-90 px-7 py-8">
          ...
          <div className="flex flex-col">
            ...
            <p className="blod-20 text-white">Kedarnath</p>
          </div>
          ...
          <div className="flexBetween">
            ...
            <div className="flex flex-col">
              ...
              <p className="bold-20 text-white">2.70 km</p>
            </div>
          </div>
        </div>
      </div>
